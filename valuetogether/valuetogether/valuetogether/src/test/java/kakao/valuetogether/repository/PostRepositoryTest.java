...
public class PostRepositoryTest {
    ...
    public void beforeEach() {
        ...
        Post post = new Post(findMember, "title", "subtitle", "article", "image", Topic.건강한삶, Target.실버세대, 10000, Timestamp.valueOf(LocalDateTime.now()), Timestamp.valueOf(LocalDateTime.now()), false);
    ...
    public void save() {
        ...
        Post post1 = new Post(findMember, "title", "subtitle", "article", "image", Topic.건강한삶, Target.실버세대, 10000, Timestamp.valueOf(LocalDateTime.now()), Timestamp.valueOf(LocalDateTime.now()), false);
